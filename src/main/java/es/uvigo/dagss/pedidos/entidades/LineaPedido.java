...
public class LineaPedido implements Serializable {
    ...
    @ManyToOne
    @JsonIgnore  // Evita ciclo al serializar en JSON Pedido<->LinePedido
    ...
    public LineaPedido(Pedido pedido, Integer cantidad, Articulo articulo) {
        this.pedido = pedido;
    ...
    public LineaPedido(Pedido pedido, Integer cantidad, Articulo articulo, Double precioVenta) {
        this.pedido = pedido;
        this.cantidad = cantidad;
        this.articulo = articulo;
